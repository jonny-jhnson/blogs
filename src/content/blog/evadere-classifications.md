...
description: "The term evasion is derived from the Latin word “evadere” which means — “To escape, to get away.” The DOD defines evasion as — “The process whereby isolated personnel avoid capture with the goal of successfully returning to areas under friendly control.”"
pubDate: 2021-06-01
...
The term evasion is derived from the Latin word “evadere” which means — “To escape, to get away.” The [**DOD**](https://www.notion.so/Bypasses-0d2d2c10b07e46b986f491089347e19b#16182368629e425d8e70fdba40283ba5) defines evasion as — “The process whereby isolated personnel avoid capture with the goal of successfully returning to areas under friendly control.”

Fairly often I come across a post on Twitter or a new blog that talks about a new ***evasion*** or ***bypass*** technique. Whether explicitly stated or not. I’ve seen posts that discuss UAC Bypass, new methods of process injection, or LSASS dumping that will bypass certain sensors or even precise detections that are released (at first this doesn’t sound like it fits into an evasion technique, but this will be explained later within the blog).

This made me think — what does ***evasion*** or ***bypass*** truly mean? Are there different categories that these evasion techniques fit into? Lastly, if these techniques are to fit into categories — how can detection engineers leverage these for engagements?
...
For example: say a red-team engagement is performed and the red-teamer ***evades*** the sensor, there are 3 scenarios that could be in effect:
...
Throughout this blog post, I will use the term ***evasion*** to reference both ***evasion*** and ***bypass*** terms because their definitions are interchangeable.

## Types of Evasions

**Note: **Throughout this write-up, I will be referring to terminology that is applied to the [**Funnel of Fidelity**](https://posts.specterops.io/introducing-the-funnel-of-fidelity-b1bb59b04036), a mapping created by Jared Atkinson. I would highly suggest reading his piece on that methodology before moving forward, as well as his talk at SO-CON — [**Rethinking Detection Engineering** ](https://youtu.be/CRtmeWCbRZQ)which goes into how to classify False Positives/False Negatives by leveraging base conditions.
...
***Collection Evasion*** is broken up into two different sub-techniques: ***End-User*** and ***Product**.* There is value in separating these two sub-techniques even though they fall under the same evasion category. One method is controlled by the customer/analyst: ***End-User***. The data is there for you to collect, enabling just needs to take place. The other method: ***Product*** is something the customer/analyst has zero control over. Neither one can control the sensor is capable of collecting, this falls on the developers of that tool. The breakdown is as follows:
...
- Product: sensor doesn’t have the visibility to see activity (**Perceptual evasion**)
...
![Figure 2](/images/evadere-classifications/_s8XPrzlBTiYGya6.png)
...
![Figure 5](/images/evadere-classifications/dhKne_7lNyUKpJFj.png)

Once we combine all of these different evasion opportunities the correlation to the funnel can be visualized as:

![Correlation Part 1](/images/evadere-classifications/v1hHUH8Hol4YdASK.png)

![Correlation Part 2](/images/evadere-classifications/kVIf2J9fbymRKy_f.png)
...
A thank you to [Jared Atkinson](https://medium.com/u/b206c297df42) for helping with these classification naming conventions, as well as discussing this methodology with me.
