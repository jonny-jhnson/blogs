...
description: "A walk through the IOC differences between Kerberoasting and AS-REP Roasting - two attack techniques that look similar at a glance but leave distinctly different traces."
pubDate: 2019-01-17
...
![Figure 1](/images/ioc-differences-kerberoasting-vs-asreproasting/F5dQCGp1_sVq5LJa.png)

![Figure 2](/images/ioc-differences-kerberoasting-vs-asreproasting/xUonZaUp66Yqlbed.png)
...
![Splunk — Threat Hunting App:Credential_Access](/images/ioc-differences-kerberoasting-vs-asreproasting/w_TRofY4DKMQPYGo.png)

![Raw Logs](/images/ioc-differences-kerberoasting-vs-asreproasting/Je5aj0vFaiCO21Bg.png)
...
1. *Credential_Access and Credential Dumping* which means someone used their credentials to gain access and dumping credentials. Which is obviously a red flag.
...
![Windows Event ID 4768: Kerberos authentication ticket (TGT) was requested](/images/ioc-differences-kerberoasting-vs-asreproasting/UFVLNeChC5dh5Snv.png)

![Windows Event ID 4769: Kerberos service ticket was requested](/images/ioc-differences-kerberoasting-vs-asreproasting/aJPFCRFbFh7_M8ml.png)
...
![Wireshark: TGS-REQ/TGS-REP](/images/ioc-differences-kerberoasting-vs-asreproasting/igQAY3f1knrOAjr-.png)
...
![Wireshark: TGS-REQ](/images/ioc-differences-kerberoasting-vs-asreproasting/Bd5jYDpiR3AfeOE8.png)

![Wireshark: TGS-REP](/images/ioc-differences-kerberoasting-vs-asreproasting/ojxTWnxAy5HJuDEE.png)

Through these two packets you can see what user was used to authenticate. Now I would like to point out, that I may have only showed one user, you will see more then one user TGS-REQ/TGS-REP under the sname tab. This is gathering other service names being requested, this is now giving the attacker the tickets for other users, which the attacker can crack the hash for their passwords as well.
...
![Analytic Logic](/images/ioc-differences-kerberoasting-vs-asreproasting/C-dXLCkhLwcwYekESlBJrg.png)
...
![Windows Event ID 4768: Kerberos authentication ticket (TGT) was requested](/images/ioc-differences-kerberoasting-vs-asreproasting/fihMtUi24R-6AOfn.png)

![Windows Event ID 4625: An account failed to log on](/images/ioc-differences-kerberoasting-vs-asreproasting/y4mHPnoVcorzJgXK.png)
...
![Wireshark: Invalid creds Red Flag](/images/ioc-differences-kerberoasting-vs-asreproasting/ULfhtMXzWIQcS5V3.png)
...
![Wireshark: AS-REQ/AS-REP](/images/ioc-differences-kerberoasting-vs-asreproasting/FwKogc9oUHupekM1.png)

![Wireshark: AS-REP](/images/ioc-differences-kerberoasting-vs-asreproasting/K4mR-eq-gOjqbIlw.png)

![Wireshark: AS-REQ](/images/ioc-differences-kerberoasting-vs-asreproasting/_wbJmSBbBTxeWFjM.png)
...
Detection Lab — Chris Long — [https://github.com/clong/DetectionLab](https://github.com/clong/DetectionLab)

Impacket — Secure Auth — [https://www.secureauth.com/labs/open-source-tools/impacket](https://www.secureauth.com/labs/open-source-tools/impacket)

Kerberoast — Tim Medin — [https://www.sans.org/cyber-security-summit/archives/file/summit-archive-1493862736.pdf](https://www.sans.org/cyber-security-summit/archives/file/summit-archive-1493862736.pdf)

AS-REP — harmj0y — [https://www.harmj0y.net/blog/activedirectory/roasting-as-reps/](https://www.harmj0y.net/blog/activedirectory/roasting-as-reps/)

Kerberos — [https://adsecurity.org](https://adsecurity.org)

*Originally published at [https://jsecurity101.com](https://jsecurity101.com/2019/IOC-differences-between-Kerberoasting-and-AsRep-Roasting/) on January 17, 2019.*
