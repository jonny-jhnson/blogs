...
description: "Part 2 of the Defender's Guide series: how Windows services work under the hood, the metadata available for them, and how to spot service abuse in telemetry."
pubDate: 2023-01-18
...
![Figure 1](/images/windows-services-defenders-guide/eXu7TzjyP1vfFCMx.png)
...
![Figure 2](/images/windows-services-defenders-guide/686ee_BOTANx7DKxg1WhIg.png)
...
![Figure 3](/images/windows-services-defenders-guide/hpN4kqMWLjXPkI5vN--z7A.png)
...
![Figure 4](/images/windows-services-defenders-guide/wka_1zZB51S27tjS.png)
...
![Figure 5](/images/windows-services-defenders-guide/sj9YQtXTBMMNSwWR.png)
...
![Figure 6](/images/windows-services-defenders-guide/Y1FOMRaq3wc6X_n3.png)
...
![Figure 7](/images/windows-services-defenders-guide/A9Vb9rmbZA7tXG7X.png)
...
![Figure 8](/images/windows-services-defenders-guide/z3j5WYK224tT7OvC.png)
...
- Non-readable service names. C2’s allow for the attacker to control what the service name is, however it isn’t uncommon for attackers to just leverage defaults when running those commands. Those defaults often include names that are unreadable and could just be a string of characters. The [DFIR Report from 2021](https://thedfirreport.com/2021/08/29/cobalt-strike-a-defenders-guide/) shows an example of this when a service was installed with the string `27b435` .
...
- Dependent on RPC call — RCreateService* being called. For more information please visit: [TelemetrySource](https://github.com/jsecurity101/TelemetrySource/tree/main/Microsoft-Windows-Security-Auditing).
...
An explanation can be found [here](https://gist.github.com/jsecurity101/b61daa2b7f2d8a7aeec187a74ea83ab1), and an example Jupyter Notebook using this telemetry can be found [here](https://posts.specterops.io/utilizing-rpc-telemetry-7af9ea08a1d5).
